...
import org.jboss.as.quickstarts.datagrid.carmart.listener.EventLogListener;
...
public class RemoteCacheContainerProvider extends CacheContainerProvider {
    ...
    public BasicCacheContainer getCacheContainer() {
        if (manager == null) {
            ...
            ((RemoteCache)manager.getCache(CarManager.CACHE_NAME)).addClientListener(listener);
